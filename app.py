...
Streamlit app: 130 БАД, 37618 papers, поиск и фильтры.
...
def main() -> None:
    ...
    st.caption("Открытая база данных о 130 добавках на основе PubMed · 37 618 papers")
    ...
    # ===== БАДы =====
    with st.expander("🔬 130 добавки — сырые данные"):
