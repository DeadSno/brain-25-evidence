...
SUPPLEMENTS_V20 = {
    ...
    'Биотин': 'biotin AND vitamin AND B7',
    'L-карнитин': 'L-carnitine',
    'BCAA': 'branched-chain AND amino AND acids',
    'Аргинин': 'L-arginine',
    'Кальций': 'calcium AND supplementation',
    'Гиалуроновая кислота': 'oral AND hyaluronic AND acid',
    'Псиллиум': 'psyllium AND husk',
    'Имбирь': 'ginger',
    'Чеснок': 'garlic AND allicin',
    'Клюква': 'cranberry AND proanthocyanidins',
    'Пустырник': 'Leonurus AND cardiaca AND motherwort',
    'Боярышник': 'hawthorn AND Crataegus',
    'Берберин': 'berberine',
    ...
    'Йохимбин': 'yohimbine',
    'Пажитник': 'fenugreek AND Trigonella',
    ...
    'Кордицепс': 'Cordyceps AND sinensis AND militaris',
    'Рейши': 'Ganoderma AND lucidum AND reishi',
    'Хлорофилл': 'chlorophyllin',
...
OUTCOME_V20 = {
    ...
    'Биотин': 'hair AND nails AND quality',
    'L-карнитин': 'weight AND loss AND muscle AND recovery',
    ...
    'Гиалуроновая кислота': 'skin AND hydration AND knee AND osteoarthritis',
    'Псиллиум': 'LDL AND cholesterol AND constipation',
    ...
    'Пустырник': 'anxiety AND sleep AND quality',
    'Боярышник': 'chronic AND heart AND failure AND symptoms AND blood AND pressure',
    ...
    'Инозитол': 'PCOS AND anxiety AND panic',
    ...
    'Астаксантин': 'skin AND elasticity AND eye AND fatigue',
    'Расторопша': 'liver AND enzymes AND NAFLD',
    'Лактоферрин': 'iron AND deficiency AND anemia',
    'SAMe': 'depression AND osteoarthritis',
    'Йохимбин': 'fat AND loss AND libido',
    'Пажитник': 'glucose AND libido',
    'Чёрный тмин': 'glucose AND lipids',
    'Трибулус': 'testosterone AND strength',
    'NMN/NR': 'physical AND function AND cognition AND aging',
    'Кордицепс': 'VO2max AND fatigue',
    'Рейши': 'sleep AND immunity AND fatigue',
    'Хлорофилл': 'acne AND body AND odor AND detox',
    'Сывороточный протеин': 'muscle AND mass AND strength AND elderly AND sarcopenia',
    'Глутамин': 'muscle AND recovery AND gut AND permeability AND immunity',
