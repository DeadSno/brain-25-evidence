...
function scienceSpan(s) {
  return '<span title="Объём доказательной базы: количество РКИ + 5 × мета-анализы в PubMed по добавке. Это метрика объёма, не силы эффекта.">🔬 наука: ' + s.scienceIndex + '</span>';
}
function maSpan(s) {
