...
| S4 | done | 53d593d (scripts/audit_frontend.py), cc48c71 (docs/audit/03-frontend.md), [STATE-коммит] (STATE.md) | audit C: 🔴1 🟡8 🟢0; map.html fetch без r.ok+.catch → белый экран; 10 innerHTML-sinks без escape (data.json first-party=🟡); theme в script.js без try/catch (SecurityError private mode); a11y: модалка без aria/фокус-трапа, категории карты не-фокусируемые, контраст бейджей v0/v1 за WCAG AA; 375px — нужна проверка человеком (playwright не установлен); d3 нет | 2026-09-13 |
